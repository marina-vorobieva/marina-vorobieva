...
<div style="display: flex; align-items: flex-start">
  ...
  <div>
    ...
    <ul style="margin: 0;">
       ...
       В последние годы все больше интересуюсь продуктовой аналитикой. Мне нравится автоматизировать процессы, выявлять зависимости и строить визуализации с помощью языков программирования SQL и Python. Сейчас я в поиске нового и надеюсь, интересного и захватывающего опыта в сегменте e-commerce.</li>
        <br>
      <br>
