 ...
 <br> 
  ...
  Что я люблю делать:
     <ul style="margin: 0 0 10 px 0; padding-left: 20 px;">
      ...
      <li>Искать связи в изменениях динамики и предлагать решения.</li>
      <li>Визуализировать — создавая понятные картины мира с помощью SQL и Python.</li>
    </ul>
    <p style="margin: 0;">
</li>
Сейчас мой основной фокус — разработка BI-решений и автоматизация отчетности. Ищу проект, где смогу применить навыки SQL и Python для создания эффективной системы аналитики.
  <br>
