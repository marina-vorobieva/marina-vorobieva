# Аналитик e-commerce
  ...
  <br>
Привет! Я Марина, маркетинговый аналитик с многопрофильным опытом: B2c – Pharma, E-commerce, B2b – логистика, производство, B2g – судоподъем. Мой опыт включает навыки: автоматизации отчетности (MDX/Olap), анализ unit-экономики, ценообразования, моделей логистики. У меня высшее маркетинговое образование и я регулярно повышаю квалификацию: SQL, Python, СУБД. Ищу роль для решения сложных аналитических задач. <br>
