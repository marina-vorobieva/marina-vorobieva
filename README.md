...
<div style="display: flex; align-items: flex-start">
  ...
  <div>
    ...
    <ul style="margin: 0;">
        Маркетинг как фундамент. Аналитика как драйвер. Моё высшее маркетинговое образование — это любовь к пониманию клиента и рынка. Сегодня мой главный интерес лежит глубже — в продуктовой аналитике.
Что я люблю делать:
Автоматизировать — чтобы повторяющиеся задачи решались сами собой.
Искать связи — там, где другие видят просто цифры.
Визуализировать — создавая понятные картины мира с помощью SQL и Python.
